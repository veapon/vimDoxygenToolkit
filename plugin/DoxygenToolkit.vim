...
if !exists("g:DoxygenToolkit_descTag")
  let g:DoxygenToolkit_descTag = ""
endif
...
if !exists("g:DoxygenToolkit_createTag")
...
if !exists("g:DoxygenToolkit_sinceTag")
  let g:DoxygenToolkit_sinceTag = "@since "
endif
if !exists("g:DoxygenToolkit_copyrightTag")
  let g:DoxygenToolkit_copyrightTag = "@copyright (C) "
endif
...
function! <SID>DoxygenAuthorFunc()
  ...
  if( g:DoxygenToolkit_copyrightString != "" )
...
function! <SID>DoxygenCommentFunc()
  ...
  if( g:DoxygenToolkit_compactOneLineDoc =~ "yes" && l:doc.returns != "yes" && len( l:doc.params ) == 0 )
    ...
    exec "normal O".strpart( s:startCommentTag, 0, 1 )
    exec "normal A".strpart( s:startCommentTag, 1 ).g:DoxygenToolkit_descTag
  else
    let s:compactOneLineDoc = "no"
    let l:insertionMode = s:StartDocumentationBlock()
    exec "normal ".l:insertionMode.s:interCommentTag.g:DoxygenToolkit_briefTag_post
  endif
  mark d
...
function! <SID>classDoxy()
  ...
  " Test versionString variable
  if !exists("g:DoxygenToolkit_String")
    "let g:DoxygenToolkit_versionString = input("Enter version string : ")
    let g:DoxygenToolkit_versionString = "v1.0"
  endif
  ...
  " package
  exec "normal o".s:interCommentTag."@package"
...
command! -nargs=0 ClassDox :call <SID>classDoxy()
command! -nargs=0 FuncDox :call <SID>funcDoxy()
command! -nargs=0 NormalDox :call <SID>funcDoxy()
